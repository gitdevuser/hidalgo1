<?php echo $header; ?>
<link rel="Stylesheet" type="text/css" href="view/javascript/jpicker-1.1.6/css/jpicker-1.1.6.min.css" />
<link rel="Stylesheet" type="text/css" href="view/javascript/jpicker-1.1.6/jPicker.css" />
<script src="view/javascript/jpicker-1.1.6/jpicker-1.1.6.min.js" type="text/javascript"></script>
...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').submit();" class="button" id="salvar" ><span><?php echo $button_save; ?></span></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><span><?php echo $button_cancel; ?></span></a></div>
    </div>
    <div class="content">
      ...
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a>
          ...
          <a href="#tab-talla">Talla / Subtalla / Color</a>
          <!--<a href="#tab-subtalla">Subtalla</a>
          <a href="#tab-color">Color</a>
          <a href="#detalle-producto">Detalle del producto</a>-->
      </div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td>
                  <input type="text" class="nombre-cat" name="product_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
              ...
              <tr style="display:none;" >
                ...
                <td><textarea class="meta-desc" name="product_description[<?php echo $language['language_id']; ?>][meta_description]" cols="40" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
              </tr>
              <tr style="display:none;">
                <td><?php echo $entry_meta_keyword; ?></td>
                <td><textarea class="meta-key" name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="40" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea></td>
              </tr>
              <tr>
              ...
              <tr style="display:none;">
                ...
                <td><input type="text" class="meta-tag" name="product_tag[<?php echo $language['language_id']; ?>]" value="<?php echo isset($product_tag[$language['language_id']]) ? $product_tag[$language['language_id']] : ''; ?>" size="80" /></td>
              </tr>
            </table>
          </div>
          <?php } ?>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr style="display:none;">
              ...
              <?php
              $selected = '';
              if ( $novedad >=1 ) { $selected = 'checked="checked"'; }
              ?>
              <td><input type="checkbox" name="novedad" <?php echo $selected; ?> ></td>
            </tr>
        ...
        <div id="tab-talla">
            ...
            <td class="left">Subtalla:</td>
			<td class="left">Color:</td>
			<td class="left">Nombre color:</td>
            </tr>
            </thead>
            <tbody>
            <tr>
			...
			<select name="talla">
			  ...
			  <?php 
			  if ( count($Tallacombo) > 0 ) {
				foreach( $Tallacombo as $combo_val ) {
					$slc = '';
					if( $combo_val['sizes_id'] == $talla ) { $slc = 'selected="selected"'; }
					echo '<option value="'.$combo_val['sizes_id'].'"
							'.$slc.' >'.$combo_val['ssize'].'</option>';
				}
			  }
			  ?>
			</select>
			...
			<select name="subtalla">
			  <option value="" >Seleccione</option>
			  <?php 
			  if ( count($SubTallacombo) > 0 ) {
				foreach( $SubTallacombo as $combo_val ) {
					$slc = '';
					if( $combo_val['secsizes_id'] == $subtalla ) { $slc = 'selected="selected"'; }
					echo '<option value="'.$combo_val['secsizes_id'].'" '.$slc.'
							>'.$combo_val['ssize'].'</option>';
				}
			  }
			  ?>
			</select>
			...
			<input type="hidden" id="image_color" name="color" value="<?php echo $color; ?>" >		  
			<img onclick="image_upload('image_color', 'preview_color');" class="image_color" id="preview_color" 
				alt="" src="<?php echo $color_img; ?>">
            </td><!-- Color -->

            <td class="left">
		
			<input type="text" id="image_color" name="nombre_color" value="<?php echo $nombre_color; ?>" >		  
            </td><!-- Nombre color -->
		...
		<!--<a href="#" class="multiple" >A&ntilde;adir Talla</a>-->
        <!--<a href="#" class="sb-multiple" >A&ntilde;adir Subtalla</a>-->
		<!--<a href="#" class="color-choose" >A&ntilde;adir Color</a>-->		
        </div><!-- Talla -->


        <div id="tab-color">
		  <div id="selec-color" ></div>
		  <div>
          <?php
          /*if ( $color ) {
          $color_items = unserialize($color);
          foreach( $color_items as $color_var ) {
              echo '<input class="Multiple" type="text" name="color[]" value="'.$color_var.'"><p>';
          }
          }*/
          ?>
		  </div>
        ...
        <div id="detalle-producto" style="display:none;" >
                <table width="300">
                  ...
                  <tr>
                   <th colspan="2" align="left" >Descuento</th>
                  </tr>

                  <tr>
                   <td align="left" ><input name="descuento" value="<?php echo $descuento; ?>" >%</td>
                  </tr>
				  
                  <tr><td>&nbsp;</td></tr>
				
                  <tr>
                   <th colspan="2" align="left" >Composici&oacute;n y cuidado</th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="composicion" value="<?php echo $composicion; ?>" /></td>
                  </tr>

                  <tr>
                    <td >Cuidado</td>
                    <td><input type="text" name="cuidado" value="<?php echo $cuidado; ?>" /></td>
                  </tr>
                ...
                <table width="300">
                  ...
                  <tr>
                   <th colspan="2" align="left" >Descripci&oacute;n General</th>
                  </tr>
                  ...
                  <tr>
                    <td colspan="2" >
                      ...
                      <?php
                      if ( $caract ) {
                           $caract_items = unserialize($caract);
                           foreach( $caract_items as $caract_var ) {
                                echo '<input type="text" name="caract[]" value="'.$caract_var.'"><p>';
                            }
                      }
                      ?>
                        <a href="#" class="anadir_caract"><i>A&ntilde;adir caracter&iacute;stica</i></a>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                   <th colspan="2" valign="top" align="left" >Corte</th>
                  </tr>
                  <tr>
                   <td colspan="2" ><textarea name="corte" ><?php echo $corte; ?></textarea></td>
                  </tr>
...
$(function(){
    $( '#tab-talla, #tab-subtalla, #selec-color, #caract' ).delegate( '.multiple, .sb-multiple, .color-choose, .anadir_caract', 'click',function(){
           var event = $( this ).attr( 'class' );
           switch ( event ) {
               case'multiple':
                  html_var = '<input name="talla[]" value="" ><p>';
                  $( this ).before( html_var );
               break;
               case'sb-multiple':
                  html_var = '<input name="subtalla[]" value="" ><p>';
                  $( this ).before( html_var );
               break;
               case'color-choose':
				html_var = '<input class="Multiple" type="text" value="ffffff" name="color[]" /><p>';
					$( this ).before( html_var );
					t = 0;
					...
					$( '#selec-color' ).find('.Multiple').eq(t).jPicker({window:{title:'Selecione color', position:{y:'10px', x:'170px'}}});
               break;
               case 'anadir_caract':
        ...
        $.fn.jPicker.defaults.images.clientPath='view/javascript/jpicker-1.1.6/images/';
        ...
        $('#Binded').jPicker({window:{title:'Binded Example', position:{x:'170px', y:''}},color:{active:new $.jPicker.Color({ahex:'993300ff'})}});
        $('.Multiple').jPicker({window:{title:'Selecione color', position:{x:'170px', y:'150px'}}});
        $('#Callbacks').jPicker(
        ...
        $( '.nombre-cat' ).change(function(){
            $( '.meta-desc, .meta-key, .meta-tag, input=[name="keyword"]' ).val( $( this ).val() );
        });


        $( '#salvar' ).click(function(){
            $( '.meta-desc, .meta-key, .meta-tag, input=[name="keyword"]' ).val( $( '.nombre-cat' ).val() );
            return false;
        });

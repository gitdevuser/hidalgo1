	...
	public function index() {
		...
		if ($files) {
			foreach ($files as $file) {
                ...
                $LeftCol[] = array(
                                    'text' => 'Editar',
                                    'href' => $this->url->link('module/extraleft', 'token=' . $this->session->data['token'] . '&extension=' . $extension, 'SSL')
					);


                $this->data['extensions'][] = array( 'name' => 'Bloques Columna Izquierda', 'action' => $LeftCol );

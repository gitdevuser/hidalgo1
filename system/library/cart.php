...
final class Cart {
  	...
  	public function add($product_id, $qty = 1, $options = array(),$extra = NULL  ) {
    	if (!$options) {
      		$key = (int)$product_id;
    	} else {

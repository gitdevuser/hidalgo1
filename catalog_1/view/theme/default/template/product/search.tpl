...
<div class="top-shadow" >&nbsp;</div>
  ...
  <div id="pages-container" class="my-account search-list"  >
  ...
  <div class="buttons">
    <div class="right"><a id="button-search" class="button"><?php echo $button_search; ?></a></div>
  </div>

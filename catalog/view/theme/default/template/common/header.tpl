  ...
  <div class="links">
    ...
    <div id="btn-red">
        <ul>
          ...
          <li>
            <iframe src="http://www.facebook.com/plugins/like.php?href&amp;send=false&amp;layout=button_count&amp;width=150&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:150px; height:21px;" allowTransparency="true"></iframe>
          </li>
        </ul>
    </div>
    ...
    <div id="cart">
      <div class="heading">
        <a href="<?php echo $link_cart; ?>" ><span id="cart_total"><?php echo $text_items; ?></span></a>
      </div>
      <div class="heading2" >
        <a href="<?php echo $checkout; ?>" class="compra"><?php echo $text_checkout; ?></a>
        <a href="<?php echo $sucursales; ?>" class="sucursales"><?php echo $text_sucursales; ?></a>
      </div>

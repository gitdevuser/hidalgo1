...
<?php echo $column_left; ?><?php echo $column_right; ?>
  ...
  <div id="pages-container" class="my-account"  >
    ...
    <h1 style="width: 250px;" ><?php echo $heading_title; ?></h1>
      ...
      <div class="pages-content shop-cart" >
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="color"><img src="<?php echo $product['color']; ?>"></td>
              <td class="talla"><?php echo $product['talla']; ?></td>
              <td class="subtalla"><?php echo $product['subtalla']; ?></td>
    ...
    <div class="buttons">
      <div class="left"><a onclick="$('#basket').submit();" class="button"><?php echo $button_update; ?></a></div>
      <div class="right"><a href="<?php echo $checkout; ?>" class="button"><?php echo $button_checkout; ?></a></div>
      <div class="center"><a href="<?php echo $continue; ?>" class="button seguir-comprando"><?php echo $button_shopping; ?></a></div>
    </div>

  ...
  <tr>
    <td style="width: 1px;"><?php if ($payment_method['code'] == $code || !$code) { ?>
      ...
      <input type="radio" name="payment_method" value="<?php echo $payment_method['code']; ?>"
                id="<?php echo $payment_method['code']; ?>" checked="checked" style="width: 15px; height: 15px;" />
      <?php } else { ?>
      <input type="radio" name="payment_method" value="<?php echo $payment_method['code']; ?>"
               id="<?php echo $payment_method['code']; ?>" style="width: 15px; height: 15px;" />
      <?php } ?></td>
...
<?php } ?>
<b><?php echo $text_comments; ?></b><p></p>
...
<?php } else { ?>
<div class="buttons">
  <div class="right"><a id="button-payment" class="button"><?php echo $button_continue; ?></a></div>
</div>
<?php } ?>

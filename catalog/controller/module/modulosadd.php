<?php  
class ControllerModuleModulosadd extends Controller {
	private $error = array(); 
	...
	public function index() {
		...
		if ($product_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/moduloadd.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/module/moduloadd.tpl';
			} else {
				$this->template = 'default/template/module/moduloadd.tpl';
			}

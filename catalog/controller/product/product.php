		...
		if ($product_info) {
				...
				$this->data['color'] = '';
                        ...
                        if ( $catID ) {
                             ...
                             foreach ( $resultsStyle as $rel_item ) {
                                 ...
                                 $selected = '';
                                 if ( $rel_item['product_id'] == $product_id ) {
                                      $selected = 'selected';
                                 }
                                ...
                                /*$ItemsbyCat[] = array( 'product_id' => $rel_item['product_id'],
                                ...
                                $Jscript .= "ProdbyCat[".$e++."] = { 'product_id':'".$rel_item['product_id']."',
                                                             ...
                                                             'talla':'".$talla."',
                                                             'subtalla':'".$subtalla."',
                                                             'precio':'".$this->currency->format($this->tax->calculate($rel_item['price'], $product_info['tax_class_id'], $this->config->get('config_tax')))."'
                                                           };";
                             }
                        }
			...
			if (($this->config->get('config_customer_price') && $this->customer->isLogged()) || !$this->config->get('config_customer_price')) {
				//$this->data['price'] = $this->currency->format($this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax')));
                                  $this->data['price'] = $this->currency->format($this->tax->calculate($precio, $product_info['tax_class_id'], $this->config->get('config_tax')));
			} else {
